...
const Footer = () => {
  const navClass =
    "text-gray-400 hover:text-white transition duration-300 text-sm";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 text-center sm:text-left">
          ...
          <div>
            ...
            <div className="flex justify-center sm:justify-start gap-4">
              <a
                href="#"
                className="px-3 py-2 bg-gray-800 rounded-md text-sm hover:bg-blue-600 transition"
              >
                Facebook
              </a>
              <a
                href="#"
                className="px-3 py-2 bg-gray-800 rounded-md text-sm hover:bg-sky-500 transition"
              >
                Twitter
              </a>
              <a
                href="#"
                className="px-3 py-2 bg-gray-800 rounded-md text-sm hover:bg-pink-600 transition"
              >
                Instagram
              </a>
            </div>
